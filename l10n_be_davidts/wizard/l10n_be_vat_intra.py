...
report_sxw.report_sxw('report.partner.vat.intra.print1', 'partner.vat.intra', 'addons/l10n_be_davidts/wizard/l10n_be_vat_intra_print1.rml', parser=vat_intra_print, header="internal")
